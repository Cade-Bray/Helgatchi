...
{
    lv_style_value_t v = lv_obj_style_apply_color_filter(obj, part,
...
{
    lv_style_value_t v = lv_obj_style_apply_color_filter(obj, part,
        lv_obj_get_style_prop(obj, part, LV_STYLE_BG_IMAGE_RECOLOR));
    return v.color;
}
...
{
    lv_style_value_t v = lv_obj_style_apply_color_filter(obj, part,
        lv_obj_get_style_prop(obj, part, LV_STYLE_IMAGE_RECOLOR));
    return v.color;
}
...
{
    lv_style_value_t v = lv_obj_style_apply_color_filter(obj, part,
        lv_obj_get_style_prop(obj, part, LV_STYLE_TEXT_OUTLINE_STROKE_COLOR));
    return v.color;
}
