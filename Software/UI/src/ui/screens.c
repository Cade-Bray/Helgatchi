...
static const char *screen_names[] = { "Main Menu", "Tutorial Splash Screen", "Tutorial", "Settings", "Info", "Template", "Alerts", "Devices" };
static const char *object_names[] = { "main_menu", "tutorial_splash_screen", "tutorial", "settings", "info", "template", "alerts", "devices", "obj0", "obj0__top_bar", "obj0__right_text", "obj0__top_bar_center_text", "obj0__left_text", "settings_top_bar", "settings_top_bar__top_bar", "settings_top_bar__right_text", "settings_top_bar__top_bar_center_text", "settings_top_bar__left_text", "obj1", "obj1__top_bar", "obj1__right_text", "obj1__top_bar_center_text", "obj1__left_text", "obj2", "obj2__top_bar", "obj2__right_text", "obj2__top_bar_center_text", "obj2__left_text", "obj3", "obj3__main_content", "obj4", "obj4__top_bar", "obj4__right_text", "obj4__top_bar_center_text", "obj4__left_text", "obj5", "obj5__alert1_1", "obj5__obj0", "obj5__obj1", "obj5__obj2", "obj6", "obj6__alert1_1", "obj6__obj0", "obj6__obj1", "obj6__obj2", "obj7", "obj7__alert1_1", "obj7__obj0", "obj7__obj1", "obj7__obj2", "obj8", "obj8__top_bar", "obj8__right_text", "obj8__top_bar_center_text", "obj8__left_text", "main_menu_scrolling_container", "overview_panel", "obj9", "devices_panel", "obj10", "alerts_panel", "games_panel", "settings_panel", "info_panel", "obj11", "obj12", "obj13", "obj14", "splash_screen_tutorial", "start_tutorial_button", "obj15", "obj16", "obj17", "obj18", "obj19", "screen_brightness_dropdown", "led_brightness_dropdown", "vibrate_on_alert_switch", "le_ds_on_alert_switch", "wake_screen_on_alert_switch", "ble_scanning_switch", "wi_fi_scanning_switch", "scan_mode_dropdown", "debug_over_serial_switch", "debug_level_dropdown", "sleep_with_serial_switch", "sleep_with_usb_switch", "sleep_button", "reboot_button", "reboot_button_1", "reboot_button_2", "obj20", "obj21", "obj22", "obj23", "device_info", "hardware_specs_container", "software_specs_container", "credits_container", "obj24", "device_1", "obj25", "obj26", "obj27", "obj28", "obj29", "obj30", "obj31", "obj32", "obj33", "obj34", "obj35", "obj36", "obj37", "obj38", "obj39", "obj40", "obj41", "obj42", "obj43", "obj44", "obj45", "obj46", "obj47", "obj48", "obj49", "obj50", "obj51", "obj52", "obj53", "obj54", "obj55", "obj56" };
...
static void event_handler_cb_tutorial_tutorial(lv_event_t *e) {
    ...
    if (event == LV_EVENT_SCREEN_LOAD_START) {
        ...
        lv_group_add_obj(groups.UINavigation, objects.obj18);
    }
...
static void event_handler_cb_tutorial_obj18(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_template_template(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
...
static void event_handler_cb_devices_devices(lv_event_t *e) {
    ...
    if (event == LV_EVENT_SCREEN_LOAD_START) {
        // group: UINavigation
        lv_group_remove_all_objs(groups.UINavigation);
        lv_group_add_obj(groups.UINavigation, objects.device_1);
...
static void event_handler_cb_alert_alert1_1(lv_event_t *e) {
    lv_event_code_t event = lv_event_get_code(e);
    void *flowState = lv_event_get_user_data(e);
    (void)flowState;
                ...
                }
                {
                    ...
                    add_style_default_main_menu_panel(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_pos(obj, 0, 0);
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                            lv_obj_add_event_cb(obj, event_handler_cb_tutorial_obj18, LV_EVENT_ALL, flowState);
                            add_style_focused___button(obj);
                            {
                                lv_obj_t *parent_obj = obj;
                                {
...
void create_screen_template() {
    ...
    (void)flowState;
    lv_obj_t *obj = lv_obj_create(0);
    objects.template = obj;
    lv_obj_set_pos(obj, 0, 0);
    lv_obj_set_size(obj, 280, 240);
    lv_obj_add_event_cb(obj, event_handler_cb_template_template, LV_EVENT_ALL, flowState);
    lv_obj_remove_flag(obj, LV_OBJ_FLAG_SCROLLABLE);
    {
        lv_obj_t *parent_obj = obj;
        {
    ...
    tick_screen_template();
}

void tick_screen_template() {
    void *flowState = getFlowState(0, 5);
    (void)flowState;
...
void create_screen_devices() {
    ...
    lv_obj_add_event_cb(obj, event_handler_cb_devices_devices, LV_EVENT_ALL, flowState);
    {
        ...
        {
            lv_obj_t *obj = lv_obj_create(parent_obj);
            lv_obj_set_pos(obj, 5607, 4092);
            lv_obj_set_size(obj, 165, 119);
            {
                lv_obj_t *parent_obj = obj;
                {
                    lv_obj_t *obj = lv_obj_create(parent_obj);
                ...
                lv_obj_t *parent_obj = obj;
                {
                    ...
                    add_style_device_card(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                            lv_obj_set_style_align(obj, LV_ALIGN_LEFT_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "Pips's Phone ");
                        }
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
                            objects.obj25 = obj;
                            ...
                            lv_obj_set_style_text_font(obj, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_text_color(obj, lv_color_hex(theme_colors[eez_flow_get_selected_theme_index()][2]), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "Apple");
                        }
                    }
                }
                {
                    ...
                    add_style_device_card(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                            lv_obj_set_style_align(obj, LV_ALIGN_LEFT_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "Pips's Watch");
                        }
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
                            objects.obj26 = obj;
                            ...
                            lv_obj_set_style_align(obj, LV_ALIGN_RIGHT_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_text_font(obj, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_text_color(obj, lv_color_hex(0xb4b4b4), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "Apple");
                        }
                    }
                }
                {
                    ...
                    add_style_device_card(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                            lv_obj_set_style_align(obj, LV_ALIGN_LEFT_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "Pips's Tablet");
                        }
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
                            objects.obj27 = obj;
                            ...
                            lv_obj_set_style_text_font(obj, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_text_color(obj, lv_color_hex(0xb4b4b4), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "Google");
                        }
                    }
                }
                {
                    ...
                    add_style_device_card(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                            lv_obj_set_style_align(obj, LV_ALIGN_LEFT_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "Pips's Ring");
                        }
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
                            objects.obj28 = obj;
                            ...
                            lv_obj_set_style_text_font(obj, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_text_color(obj, lv_color_hex(0xb4b4b4), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "Oura");
                        }
                    }
                }
                {
                    ...
                    add_style_device_card(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                            lv_obj_set_style_align(obj, LV_ALIGN_LEFT_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "Pips's headphones");
                        }
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
                            objects.obj29 = obj;
                            ...
                            lv_obj_set_style_text_font(obj, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_text_color(obj, lv_color_hex(0xb4b4b4), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "Sony");
                        }
                    }
                }
                {
                    ...
                    add_style_device_card(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                            lv_obj_set_style_align(obj, LV_ALIGN_LEFT_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "Pips's Vape");
                        }
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
                            objects.obj30 = obj;
                            ...
                            lv_obj_set_style_text_font(obj, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_text_color(obj, lv_color_hex(0xb4b4b4), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "Vapes");
                        }
                    }
                }
                {
                    ...
                    add_style_device_card(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                            lv_obj_set_style_align(obj, LV_ALIGN_LEFT_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "Your mom");
                        }
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
                            objects.obj31 = obj;
                ...
                }
                {
                    ...
                    add_style_device_card(obj);
                    {
                        ...
                        }
                        {
                            ...
                            lv_obj_set_size(obj, LV_SIZE_CONTENT, LV_SIZE_CONTENT);
                            lv_obj_set_style_align(obj, LV_ALIGN_LEFT_MID, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "OBD2");
                        }
                        {
                            lv_obj_t *obj = lv_label_create(parent_obj);
                            objects.obj32 = obj;
                            ...
                            lv_obj_set_style_text_font(obj, &lv_font_montserrat_12, LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_obj_set_style_text_color(obj, lv_color_hex(0xb4b4b4), LV_PART_MAIN | LV_STATE_DEFAULT);
                            lv_label_set_text_static(obj, "AXON");
                        }
                    }
                }
            }
...
void create_user_widget_alert(lv_obj_t *parent_obj, void *flowState, int startWidgetIndex) {
    ...
    lv_obj_t *obj = parent_obj;
    {
        lv_obj_t *parent_obj = obj;
        {
            ...
            lv_obj_set_pos(obj, 0, 0);
            lv_obj_set_size(obj, LV_PCT(100), LV_SIZE_CONTENT);
            lv_obj_add_event_cb(obj, event_handler_cb_alert_alert1_1, LV_EVENT_ALL, flowState);
...
void change_color_theme(uint32_t theme_index) {
    {
        lv_obj_set_style_text_color(objects.obj15, lv_color_hex(theme_colors[theme_index][2]), LV_PART_MAIN | LV_STATE_DEFAULT);
    }
    {
    ...
    lv_obj_invalidate(objects.template);
